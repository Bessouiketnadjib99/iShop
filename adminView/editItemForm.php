...
<form id="update-Items" onsubmit="updateItems()" enctype='multipart/form-data'>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="p_brand" value="<?=$row1['product_brand']?>">
    </div>
   
    <div class="form-group">
      <label for="name">Product Color:</label>
      <input type="text" class="form-control" id="p_color" value="<?=$row1['product_color']?>">
    </div>
   
    <div class="form-group">
      <label for="name">Product Storage:</label>
      <input type="text" class="form-control" id="p_storage" value="<?=$row1['product_storage']?>">
    </div>
