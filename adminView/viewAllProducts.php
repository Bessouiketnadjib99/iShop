  ...
  <table class="table ">
    <thead>
      <tr>
        ...
        <th class="text-center">Product Storage</th>
        ...
        <div class="modal-body">
          <form  enctype='multipart/form-data' onsubmit="addItems()" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="p_brand" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="name">Product Storage:</label>
              <input type="text" class="form-control" id="p_storage" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="qty">URL:</label>
              <input type="text" class="form-control" id="p_url" required>
            </div>
            <div class="form-group">
