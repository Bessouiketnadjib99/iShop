...
<div id="mobile">
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="./uploads/iPhone8Plus_color_selection_inline.jpg.large.jpg" width="100%" id="MainImg" alt="iPhone 8">
        </div>
        <div class="single-pro-details">
            ...
            <form method="GET" action="checkout2.php">
                <input type="hidden" name="product_brand" value="Apple">
                <input type="hidden" name="product_name" value="iPhone 8">
                <input type="hidden" name="price" value="66000">
                <input type="hidden" name="product_storage" value="128">
